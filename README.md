...
```css
@import 'tailwindcss';
@source "../node_modules/layout-ui/dist";
```
...
import { LayoutSelect } from 'layout-ui'
import type { IOption } from 'layout-ui'
...
```tsx
import { LayoutSelect } from 'layout-ui/layout/select'
import type { IOption } from 'layout-ui/layout/select'
```
